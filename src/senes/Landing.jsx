...
import imgProfile from "../assets/thapaa.jpg"
import Thapa from "../assets/thapa.jpg"
          ...
          {isAboveLarge ? (
            ...
            >
                     ...
                     <p className='mt-10 mb-7 text-sm text-center md:text-start '>
                        Hello my name is Amrit Jung Thapa and I am Web Developer
                ...
                <motion.div
                className='flex mt-5 justify-center md:justify-start ml-10'
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once:true, amount:0.5 }}
