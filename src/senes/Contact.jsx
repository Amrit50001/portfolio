...
import ContImage from "../assets/contact-image.jpeg"
    ...
    <section id='contact' className='py-48'>
        ...
        <div className='md:flex md:justify-between gap-16 mt-10'>
            ...
            >
                ...
                target='_blank'
                onSubmit={onSubmit}
                action='https://formsubmit.co/a079f1000b737ee26ea77895a829bf40'
                method='POST'
                >
                    <input 
